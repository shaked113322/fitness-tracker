    ...
    <div className="space-y-6 animate-fade-in">
      ...
      {photos.length === 0 ? (
        <div className="bg-gray-900 border border-gray-800 rounded-xl p-12 text-center">
          ...
          <p className="text-gray-600 text-sm mt-1">צלם תמונה ראשונה ותתחיל לעקוב אחרי השינויים</p>
          <Link
            href="/photos/new"
          ...
          {photos.map((photo) => (
            <div key={photo.id} className="bg-gray-900 border border-gray-800 rounded-xl overflow-hidden">
              <div className="relative aspect-[3/4]">
                <Image
                  src={photo.url}
                  alt={photo.description || "תמונת התקדמות"}
                  fill
              ...
              <div className="p-3">
                <p className="text-xs text-gray-500">
                  {format(new Date(photo.date), "d בMMMM yyyy")}
                </p>
                {photo.description && (
